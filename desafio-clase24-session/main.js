...
const MongoStore = require("connect-mongo"); //min 1.25 clase 24
...
app.use(
  session({
    store: MongoStore.create({
        //mongoUrl: 'mongodb://localhost:27017/30965_sessions'
      mongoUrl:"mongodb+srv://pia:tpu2iLVfcN9Tua5K@@cluster0.5z86n.mongodb.net/30965_sessions?retryWrites=true&w=majority",
